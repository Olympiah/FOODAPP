...
import { ScrollView, StatusBar, TouchableOpacity, View,TextInput,FlatList,Text,Image} from 'react-native';
           ...
           <View 
             style={{
              ...
              <View style={{
                ...
                <Entypo 
                  name='plus'
                  style={{fontSize:10,color:COLOURS.black}}
               />
              </View>
              <View 
                style={{
    ...
    return (
        ...
        <ScrollView showsHorizontalScrollIndicator={false}>
            ...
            style={{
               ...
               <Image source={require('../database/images/background.jpeg')} 
               style={{position:'absolute', top:0 ,left:-100,resizeMode:'cover',}}
               />
               <View 
                 style={{
                   flexDirection:'row',
                 ...
                 <TouchableOpacity 
                  ...
                  <Image
                    source={require('../database/images/profile.jpeg')}
                    style={{
                      width:'100%',
                      height:'100%',
                      resizeMode:'contain',
               ...
               <Ionicons 
                 name='search'
                 style={{ fontSize:20,color: COLOURS.black,opacity:0.5}}
               />
               <TextInput 
                 placeholder='Search...'
                 style={{
